...
const About = () => {
  ...
  const skills = ['Java 8', 'SQL', 'Javascript', 'PrimeFaces', 'Spring'];
      ...
      <div className="inner">
        <StyledText>
          <div>
            ...
            <p>
              I enjoy building new things from scratch. I love designing and developing web sites
              and video games and, whenever I do it, I make sure to learn as much as I can and to
              have fun!
            </p>
